...
y_pred_proba = rf_model.predict_proba(X_test_tfidf)[:, 1]  # Probabilidades para la clase 1

# Ajustar el umbral de clasificación (por ejemplo, 0.3)
threshold = 0.25
y_pred_adjusted = (y_pred_proba >= threshold).astype(int)  # Se ajusta el umbral a 0.3 o el valor que se necesite
